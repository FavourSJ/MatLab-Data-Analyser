...
hold on
 plot(da(2:6,1),da(2:6,2),'-ok', 'MarkerSize',10','lineWidth', 3' );
hold on

plot(da(2:6,1),da(2:6,3),'--xk', 'MarkerSize',15','lineWidth', 3');
hold on
...
title ("NACA4412 Average Results")
xlabel ("Reynold Number");
ylabel ("Drag Coefficient Cd (dashed), Lift Coefficient Cl (Solid)")

legend ("Cl 0 Degrees","Cd 0 Degrees","Cl 4 Degrees","Cd 4 Degrees","Cl 6 Degrees","Cd 6 Degrees","Cl 12 Degrees","Cd 12 Degrees","Cl 15(stall) Degrees","Cd 15(stall) Degrees","Cl 25(max) Degrees","Cd 25(max) Degrees","Cl -3 Degrees","Cd -3 Degrees")
grid on
...
whitebg([0.3010 0.7450 0.9330])
hold on
plot(da(2:7,3),da(2:7,2),'+k', 'MarkerSize',10','lineWidth', 1' );
hold on
...
title ("NACA4412 Average Coefficients");
ylabel ("Lift Coefficient");
xlabel ("Drag Coefficient");

legend ("0 Degrees","4 Degrees","6 Degrees","12 Degrees","15(stall) Degrees","25(max) Degrees","-3 Degrees")
grid on
