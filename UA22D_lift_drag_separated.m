...
title ("UA2-2D Lift Coefficient against Reynolds Number")
xlabel ("Reynold Number");
ylabel ("Lift Coefficient Cl")

legend ("Cl 0 Degrees","Cl 2 Degrees","Cl -3 Degrees","Cl 6 Degrees","Cl 12 Degrees","Cl 15 Degrees","Cl 18 Degrees","Cl 25 Degrees")
grid on
...
plot(da(1:6,1),da(1:6,3),'-ok', 'MarkerSize',10','lineWidth', 3');
hold on

plot(da(7:13,1),da(7:13,3),'-yo', 'MarkerSize',10','lineWidth', 3');
hold on
...
plot(da(44:50,1),da(44:50,3),'-ow', 'MarkerSize',10','lineWidth', 3');
hold on

title ("UA2-2D Drag Coefficient against Reynolds Number")
xlabel ("Reynold Number");
ylabel ("Drag Coefficient Cd")

legend ("Cd 0 Degrees","Cd 2 Degrees","Cd -3 Degrees","Cd 6 Degrees","Cd 12 Degrees","Cd 15 Degrees","Cd 18 Degrees","Cd 25 Degrees")
grid on
